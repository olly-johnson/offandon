...
| BO-037 | Methodology layer: house-style methodology section in AGENTS.md, loaded the same way as the Manifesto. Applies to every user as a baseline before per-user methodology layers in. | - | Todo | - |
